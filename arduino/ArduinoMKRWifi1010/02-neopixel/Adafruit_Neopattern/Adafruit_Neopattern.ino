/*
 * Adapted from:
 * Adafruit tutorials: Multi-tasking the Arduino - Part 3
...
NeoPatterns Strip1(30, 5, NEO_GRB + NEO_KHZ800, &Strip1Complete);
NeoPatterns Strip2(30, 4, NEO_GRB + NEO_KHZ800, &Strip2Complete);
...
void Strip1Complete()
{
    ...
    {
        // Alternate color-wipe patterns with Strip2
        Strip2.Interval = 40;
...
void Strip2Complete()
{
    if (digitalRead(9) == LOW)  // Button #2 pressed
    {
        // Alternate color-wipe patterns with Strip1
        Strip1.Interval = 20;
        Strip2.Color1 = Strip2.Wheel(random(255));
        Strip2.Interval = 20000;
    }
    else  // Retrn to normal
    {
